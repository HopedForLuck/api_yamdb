# Generated by Django 3.2 on 2023-10-07 09:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(db_index=True, validators=[reviews.models.year_validator], verbose_name='Год выхода')),
        ...
        migrations.CreateModel(
            name='Category',
            fields=[
                ('nameslugclass_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='reviews.nameslugclass')),
            ],
            options={
