    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[django.core.validators.RegexValidator(message='Слаг для категории содержит недопустимый символ', regex='^[-a-zA-Z0-9_]+$')], verbose_name='slug')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, unique=True, verbose_name='Hазвание')),
                ('slug', models.SlugField(unique=True, validators=[django.core.validators.RegexValidator(message='Слаг для жанра содержит недопустимый символ', regex='^[-a-zA-Z0-9_]+$')], verbose_name='slug')),
            ],
            options={
                'verbose_name': 'Жанр',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(db_index=True, validators=[django.core.validators.MinValueValidator(0, message='Это произведение слишком старо для нас'), django.core.validators.MaxValueValidator(2023, message='Мы не можем заглядывать в будущее')], verbose_name='Год выхода')),
